...
ALIASES={
 ...
 'business':['업무구분','business'],
 'message_type':['타입','메시지타입','message_type','messagetype','type'],
 'purpose':['용도','purpose'],
 'title':['타이틀','제목','title'],
 'title_en':['영문타이틀','영문제목','title_en','titleen'],
 'message_en':['영문컨텐츠','영문콘텐츠','message_en','messageen'],
 'message':['컨텐츠','콘텐츠','등록문구','표시문구','알림문구','메시지','메세지','문구','내용','message','text'],
        ...
        for rn,raw in sorted(rows.items()):
            ...
            records.append({'code':code,'message':message,'menu':values.get('menu',''),
                ...
                'source':{'filename':filename,'sheet':sheet['name'],'row':rn,
                          ...
                          'catalog_fields':{k:values[k] for k in ('business','message_type','purpose','title','title_en','message_en') if k in values},
